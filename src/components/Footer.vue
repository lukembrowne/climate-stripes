<template>
  <footer>
    <div class="flex-container" :style="[titleStyle]">
      <span class="box-1">
      ...
      <span class="box-4">
        <a
          href="https://github.com/lukembrowne/climate-stripes"
          target="_blank"
        >
          <svg
        ...
        <a href="https://twitter.com/lukembrowne" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            :width="iconSize"
            :height="iconSize"
...
export default {
  ...
  computed: {
    ...
    iconSize: function () {
      if (this.barHeight < 200) {
        return 5;
      } else if (this.barHeight < 250) {
        return 10;
      } else {
        return 16;
      }
